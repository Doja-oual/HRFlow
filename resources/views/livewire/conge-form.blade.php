<div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
    @if (Auth::check())
        ...
        <form wire:submit.prevent="submit" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">Jours demandes</label>
                <input type="number" wire:model="total_days" readonly class="w-full border-gray-300 rounded-md bg-gray-100 shadow-sm">
            </div>
